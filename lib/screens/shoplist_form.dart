            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  onChanged: (String? value) {
                    setState(() {
                      // TODO: Tambahkan variabel yang sesuai (DONE) // TODO: Tambahkan variabel yang sesuai (DONE)
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  onChanged: (String? value) {
                    setState(() {
                      // TODO: Tambahkan variabel yang sesuai (DONE)
                      _description = value!;
                    });
                  },
                  validator: (String? value) {
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        final response = await request.postJson(
                            // http://rahida-syafa-tutorial.pbp.cs.ui.ac.id/create-flutter/
